import { forwardRef, useEffect, useRef, useState, ChangeEvent, ReactNode, Ref } from 'react';
...
const StyledGridOverlay = styled(Stack)(({ theme }) => ({
  ...
  '& .ant-empty-img-3': {
    fill: theme.palette.mode === 'light' ? theme.palette.secondary[200] : theme.palette.secondary[400]
  },
  '& .ant-empty-img-4': {
    fill: theme.palette.mode === 'light' ? theme.palette.common.white : theme.palette.secondary.dark
  },
  '& .ant-empty-img-5': {
