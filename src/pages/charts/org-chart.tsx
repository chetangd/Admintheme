    ...
    <Grid container rowSpacing={2} justifyContent="center">
      <Grid item md={12} lg={12} xs={12}>
        <Grid container spacing={2}>
          <Grid item md={12} lg={12} xs={12}>
            <MainCard title="Simple Chart" sx={{ overflow: 'auto' }} contentSX={{ direction: theme.direction }}>
              <Tree
                lineWidth="1px"
          ...
          <Grid item md={12} lg={12} xs={12}>
            <MainCard title="Styled Chart" sx={{ overflow: 'auto' }} contentSX={{ direction: theme.direction }}>
              <Tree
                lineWidth="1px"
                lineColor={theme.palette.primary.main}
                lineBorderRadius="4px"
