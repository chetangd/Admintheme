import { useState, ChangeEvent, MouseEvent, SetStateAction, SyntheticEvent } from 'react';
...
export default function EnhancedTable() {
  ...
  const handleClick = (event: MouseEvent<HTMLTableRowElement> | undefined, name: string) => {
