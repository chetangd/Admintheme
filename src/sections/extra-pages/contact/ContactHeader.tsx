...
function ContactHeader() {
  ...
  return (
    <MainCard
      sx={{
        bgcolor: theme.palette.mode === 'dark' ? theme.palette.secondary.dark : theme.palette.secondary[100],
        border: 'transparent',
        borderRadius: 0,
      ...
      <Container maxWidth="lg" sx={{ px: { xs: 0, sm: 2 } }}>
        <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-around" alignItems="center" spacing={{ xs: 0, sm: 3 }}>
          ...
          <Box sx={{ width: { xs: 320, sm: 320, md: 500, lg: 600 } }}>
            <img
              src={worldMap}
              alt="world map contact us"
              style={{
                width: '100%',
                background: theme.palette.mode === 'dark' ? theme.palette.secondary.dark : theme.palette.secondary[100]
              }}
            />
          </Box>
        </Stack>
